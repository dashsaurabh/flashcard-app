...
import org.domain.user.management.services.queries.UserQueryService;
...
@Api(value = "User Queries", description = "Read User Data", tags = "User Queries")
public class UserQueryController {
    ...
    @GetMapping(value = "/hello-manage")
    public String helloMessage() {
        return new String("hello-manage");
    }
    ...
    private ResponseEntity<UserQueryDTO> getUserByUserName(@ApiParam("User Name for which details should be fetched")
        ...
        return new ResponseEntity<>(userQueryService.getUserInfoByUserName(userName), HttpStatus.OK);
    }
